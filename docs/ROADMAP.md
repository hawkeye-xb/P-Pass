...
- [ ] **REBUILD-04 Worker 切换、最小状态呈现与首包验收** — **2026-09-01 代码完成，待三星首验**：Worker 已降为 Flow wake adapter，UI 从账本投影 user pause / waiting / transferring / cancelled round，Continue / Cancel 走严格消费者。Android JVM 250 tests / 0 failures / 4 skipped、debug APK 成功；仅剩测试相册的 Pause → kill → Continue → Cancel 真机验证。
