...
| 卡片 | 日期 | Commit | 状态 | 摘要 |
|------|------|--------|------|------|
| **ARCH-01 首批 P0 实施卡（ARCH-02~05）** | 2026-08-31 | 本 commit | 🟡 待验收人 review，零生产代码 | 按 ARCH-01 Case Matrix 的执行顺序创建四张纵向卡：ARCH-02（D-01~D-04 手机账本/发现原子提交）、ARCH-03（C-01~C-05 严格消费者与 Pause/条件等待）、ARCH-04（E-01~E-04 完成凭据与 ScopeRevision）、ARCH-05（X-01~X-05 取消本轮）。四卡均要求先写对应新 case 的失败测试，且不准修改旧 WorkManager 管线、调度、UI、Rust 或传输协议；待 review 仅核对 case 覆盖、依赖顺序、范围与反证，不重开 ARCH-01 产品语义。 |
