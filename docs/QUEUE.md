...
> （开发机本地文件，不进 git）。
>
> 最后核对：**2026-08-29**（ARCH-01 已收口严格单张消费、原生 iroh-blobs 续传、Pause/条件等待、范围修改与取消积压；下一步拆实施卡）
...
| 优先级 | 卡 | 一句话 | 级别 |
|---|---|---|---|
| P1 | [ARCH-01](../cards/ARCH-01-backup-core-flow-queue-design.md) | 备份核心流程已收口：500 项发现窗口 + 严格单张消费 + 原生 iroh-blobs fetch/resume；范围增加补扫、范围减少重建、取消积压与恢复语义已定，下一步拆实施卡 | L2 |
