...
| 卡 | 当前节点 | 下一步 | 级别 |
|---|---|---|---|
| [MOB-72](../cards/MOB-72-scope-selection-must-wake-flow-without-relaunch.md) | 范围保存已有 backfill + 用户在场 wake 调用，尚未证明实际 runner 执行 | 从 runtime、WorkManager KEEP 与取消轮 gate 构造 RED 路径 | L2 |
---
