...
| 优先级 | 卡 | 一句话 | 级别 |
|---|---|---|---|
| P1 | [MOB-68](../cards/MOB-68-optional-permissions-map-to-backup-settings.md)（合并 [MOB-67](../cards/MOB-67-notify-on-failure-switch-never-sends-notification.md)） | 授权流程已完成真机回归；待接通“备份失败时通知我”的真实系统通知发送 | L2 |
