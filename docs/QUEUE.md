...
| 卡 | 一句话 | 当前节点 |
|---|---|---|
| [BLOB-03](../cards/BLOB-03-android-provider-store-never-reclaimed.md) | Android provider store 回收机会性回归 | 只读检查自然新增 Flow；receipt 后 60 秒核对 provider data blob 回收，不伪造媒体/不重置配对 |
