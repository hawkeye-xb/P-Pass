...
| [REBUILD-06](../cards/REBUILD-06-flow-offer-authz-after-scope-backfill.md) | member epoch refresh + runtime / delivery guard 已绿 | 更新 Desktop daemon 后不清数据复验三星 Pause | `main` |
